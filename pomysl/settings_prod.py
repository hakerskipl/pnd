...
DATABASES = {
    'default': {
        ...
        'NAME': 'pnd',                      # Or path to database file if using sqlite3.
...
SECRET_KEY = '7gni409r31^@yy_1)_v4dme9+(7(q_@!ehzrcmf7-g4cj%v1d0'
