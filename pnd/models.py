...
class Place(models.Model):
	...
	hour_open = models.TimeField(null=True, blank=True, verbose_name=u'Godzina otwarcia')
	hour_close = models.TimeField(null=True, blank=True, verbose_name=u'Godzina zamknięcia')
