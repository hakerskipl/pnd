...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Place.hour_close'
        db.delete_column(u'pnd_place', 'hour_close')

        # Deleting field 'Place.hour_open'
        db.delete_column(u'pnd_place', 'hour_open')

        # Adding field 'Place.mon_hour_open'
        db.add_column(u'pnd_place', 'mon_hour_open',
                      self.gf('django.db.models.fields.TimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Place.mon_hour_close'
        db.add_column(u'pnd_place', 'mon_hour_close',
                      self.gf('django.db.models.fields.TimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Place.tue_hour_open'
        db.add_column(u'pnd_place', 'tue_hour_open',
                      self.gf('django.db.models.fields.TimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Place.tue_hour_close'
        db.add_column(u'pnd_place', 'tue_hour_close',
                      self.gf('django.db.models.fields.TimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Place.wed_hour_open'
        db.add_column(u'pnd_place', 'wed_hour_open',
                      self.gf('django.db.models.fields.TimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Place.wed_hour_close'
        db.add_column(u'pnd_place', 'wed_hour_close',
                      self.gf('django.db.models.fields.TimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Place.thr_hour_open'
        db.add_column(u'pnd_place', 'thr_hour_open',
                      self.gf('django.db.models.fields.TimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Place.thr_hour_close'
        db.add_column(u'pnd_place', 'thr_hour_close',
                      self.gf('django.db.models.fields.TimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Place.fri_hour_open'
        db.add_column(u'pnd_place', 'fri_hour_open',
                      self.gf('django.db.models.fields.TimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Place.fri_hour_close'
        db.add_column(u'pnd_place', 'fri_hour_close',
                      self.gf('django.db.models.fields.TimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Place.sat_hour_open'
        db.add_column(u'pnd_place', 'sat_hour_open',
                      self.gf('django.db.models.fields.TimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Place.sat_hour_close'
        db.add_column(u'pnd_place', 'sat_hour_close',
                      self.gf('django.db.models.fields.TimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Place.sun_hour_open'
        db.add_column(u'pnd_place', 'sun_hour_open',
                      self.gf('django.db.models.fields.TimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Place.sun_hour_close'
        db.add_column(u'pnd_place', 'sun_hour_close',
                      self.gf('django.db.models.fields.TimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Place.hour_close'
        db.add_column(u'pnd_place', 'hour_close',
                      self.gf('django.db.models.fields.TimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Place.hour_open'
        db.add_column(u'pnd_place', 'hour_open',
                      self.gf('django.db.models.fields.TimeField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Place.mon_hour_open'
        db.delete_column(u'pnd_place', 'mon_hour_open')

        # Deleting field 'Place.mon_hour_close'
        db.delete_column(u'pnd_place', 'mon_hour_close')

        # Deleting field 'Place.tue_hour_open'
        db.delete_column(u'pnd_place', 'tue_hour_open')

        # Deleting field 'Place.tue_hour_close'
        db.delete_column(u'pnd_place', 'tue_hour_close')

        # Deleting field 'Place.wed_hour_open'
        db.delete_column(u'pnd_place', 'wed_hour_open')

        # Deleting field 'Place.wed_hour_close'
        db.delete_column(u'pnd_place', 'wed_hour_close')

        # Deleting field 'Place.thr_hour_open'
        db.delete_column(u'pnd_place', 'thr_hour_open')

        # Deleting field 'Place.thr_hour_close'
        db.delete_column(u'pnd_place', 'thr_hour_close')

        # Deleting field 'Place.fri_hour_open'
        db.delete_column(u'pnd_place', 'fri_hour_open')

        # Deleting field 'Place.fri_hour_close'
        db.delete_column(u'pnd_place', 'fri_hour_close')

        # Deleting field 'Place.sat_hour_open'
        db.delete_column(u'pnd_place', 'sat_hour_open')

        # Deleting field 'Place.sat_hour_close'
        db.delete_column(u'pnd_place', 'sat_hour_close')

        # Deleting field 'Place.sun_hour_open'
        db.delete_column(u'pnd_place', 'sun_hour_open')

        # Deleting field 'Place.sun_hour_close'
        db.delete_column(u'pnd_place', 'sun_hour_close')
    ...
    models = {
        ...
        u'pnd.todaysidea': {
            ...
            'date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 4, 21, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
