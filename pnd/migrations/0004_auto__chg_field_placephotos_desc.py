...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PlacePhotos.desc'
        db.alter_column(u'pnd_placephotos', 'desc', self.gf('django.db.models.fields.TextField')(null=True))

    def backwards(self, orm):

        # Changing field 'PlacePhotos.desc'
        db.alter_column(u'pnd_placephotos', 'desc', self.gf('django.db.models.fields.TextField')(default=''))
