...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Place.fb'
        db.add_column(u'pnd_place', 'fb',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Place.fb'
        db.delete_column(u'pnd_place', 'fb')
    ...
    models = {
        ...
        u'pnd.todaysidea': {
            ...
            'date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 4, 22, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
