...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Tags.icon'
        db.alter_column(u'pnd_tags', 'icon', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

    def backwards(self, orm):

        # Changing field 'Tags.icon'
        db.alter_column(u'pnd_tags', 'icon', self.gf('django.db.models.fields.CharField')(default='', max_length=50))
    ...
    models = {
        ...
        u'pnd.tags': {
            ...
            'icon': ('django.db.models.fields.CharField', [], {'default': 'None', 'max_length': '50', 'null': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
