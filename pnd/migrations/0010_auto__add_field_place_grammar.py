...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Place.grammar'
        db.add_column(u'pnd_place', 'grammar',
                      self.gf('django.db.models.fields.CharField')(default=u'Lokal', max_length=150, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Place.grammar'
        db.delete_column(u'pnd_place', 'grammar')
