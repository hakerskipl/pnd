...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'TodaysIdea.date'
        db.alter_column(u'pnd_todaysidea', 'date', self.gf('django.db.models.fields.DateField')())
        # Adding field 'Place.short'
        db.add_column(u'pnd_place', 'short',
    ...
    def backwards(self, orm):
        ...
        # Changing field 'TodaysIdea.date'
        db.alter_column(u'pnd_todaysidea', 'date', self.gf('django.db.models.fields.DateField')(auto_now_add=True))
        # Deleting field 'Place.short'
        db.delete_column(u'pnd_place', 'short')
    ...
    models = {
        ...
        u'pnd.todaysidea': {
            ...
            'date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 4, 2, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
